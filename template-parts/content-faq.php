...
<ul class="faq-list">
	...
	?>
		<li><a href="<?php the_permalink(); ?>" aria-label="Read more about <?php the_title(); ?>"><?php the_title(); ?></a></li>
	<?php endwhile; ?>
</ul>
<?php endif; ?>
<?php wp_reset_query(); ?>
...
<?php if ( $medical_concerns ->have_posts() ) : ?>
<ul class="faq-list">
	<?php
