...
<?php endwhile; endif; ?>
    ...
    <section class="panel-carousel bg-forest bg-logomark" aria-label="Case Results Carousel">
    <div class="container">
    <div class="row">
    ...
    <div class="carousel-contain"> 
        <?php while( $the_query->have_posts() ) : $the_query->the_post(); ?>
            <div class="single-panel" aria-label="Case Result">
                ...
                <a href="<?php echo get_permalink( $post->ID ); ?>" aria-label="Read more about <?php echo get_the_title( $post->ID ); ?>">Read More</a>
            </div>
        <?php endwhile; ?>
    </div>
    </div>
