<section class="pages-cta" id="page_cta-banner">
    <div class="row">
        <div class="single-page">
			...
			<p class="contact-number"><?php the_field('cta_banner_english', 'options'); ?> <a href="tel:(424) 392-7649" aria-label="Call (424) 392-7649">(424) 392-7649</a></p>
			<?php } else { ?>
			<p class="contact-number"><?php the_field('cta_banner_spanish', 'options'); ?> <a href="tel:(424) 392-7649" aria-label="Llamar al (424) 392-7649">(424) 392-7649</a></p>
			<?php } ?>
            </div>
			<div class="shedule-consiltation">
					<a href="https://aa.law/contact-us/" aria-label="<?php if (get_locale() == 'en_US') { echo 'Schedule Consultation'; } else { echo 'Agendar Consulta'; } ?>"><i class="fa-solid fa-phone"></i> <?php if (get_locale() == 'en_US') { ?> Schedule Consultation	<?php } else {  ?>Agendar Consulta    <?php } ?></a>
			</div>
        ...
        <div class="single-page second-single">
            <div class="copy text-center">
                ...
                <div class="single-page  single-with-background" >
					<div class="copy text-center">
					     <img src="https://aa.law/wp-content/uploads/2024/06/AdobeStock_566632321-1-1.png" alt="A person in a suit confidently shaking hands with someone else in an office, possibly discussing a personal injury lawsuit in Los Angeles and expressing confidence that they can win." aria-label="Person shaking hands in office, possibly discussing a personal injury lawsuit">
					   </div>
